...
**"Reveal invisible world of Magnetic field!"**  
...
**[COMSOL](https://www.comsol.com/) is too expansive! I made this for moneyless students**

**You can run this in Google Colab WITHOUT any graphics card!**

---

## **Intruduction & Google Colab**
...
- **User-given Electric Currents**: Free to arrange shape(circle or line), intensity(Amphere), and position(3D vector) of the Electric current.
...
## **🛠 To run this in your computer, You need NVIDIA graphics card! If you don't have one, run this in [Google Colab](https://colab.google/)**
...
- **My setup**: CUDA 13.1, CuPy 13.6.0, NumPy 2.4.0 (If something goes wrong with the libraries, try simullar versions.)
...
- **Step 1**: Add your elelctric current information into "Request list" by clicking "Request" button after you finish entering electric current informations(shape, intensity, coordinates).
